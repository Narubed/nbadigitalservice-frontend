...
function button1(props) {
  ...
  useEffect(() => {
    if (isValues) {
      setLink(isValues.button1_link);
      setWidth(isValues.button1_width);
    }
  }, [isValues]);
  ...
  return (
    <div>
      ...
      {imgSrc ? (
        ...
        <img
          src={`${process.env.REACT_APP_WEB_SERVICE}/static/first-page/${isValues.button1}`}
          alt={`${process.env.REACT_APP_WEB_SERVICE}/static/first-page/${isValues.button1}`}
        />
      )}
