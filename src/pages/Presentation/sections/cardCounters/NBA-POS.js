        ...
        {action && (
          <MKBox width="50%" mt={2} mb={2} mx="auto">
            {action.type === 'external' ? (
              <MKButton
                onClick={() => window.open('https://nba-pos.nbadigitalservice.com/', '_blank')}
                component={MuiLink}
                href={action.route}
                target="_blank"
                rel="noreferrer"
...
function NBAExpress() {
  return (
    <MKBox sx={{ pr: 1, pl: 1 }}>
      <RotatingCard>
        <RotatingCardFront
          image={require('../../../../assets/images/NBAService/logo/logoWeb/NBA-POS.png').default}
          icon="touch_app"
          title={<>NBA POS</>}
        ...
        <RotatingCardBack
          image={require('../../../../assets/images/NBAService/logo/logoWeb/NBA-POS.png').default}
          title="NBA POS"
          description="ระบบจัดการขายหน้าร้าน."
          action={{
            type: 'internal',
            route: 'https://nba-pos.nbadigitalworlds.com/',
            label: 'เว็บไซต์'
          }}
        />
      </RotatingCard>
