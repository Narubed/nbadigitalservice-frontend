          ...
          <MKBox width="50%" mt={2} mb={2} mx="auto">
            {action.type === 'external' ? (
              <MKButton
                onClick={() =>
                  window.open(
                    'https://www.jumpconnect.net/member/member_register.php?sp_code=0001938&qr_code=1/',
                    '_blank'
                  )
                }
                component={MuiLink}
...
function Information() {
  return (
    ...
    <Container>
      <RotatingCard>
        <RotatingCardFront
          image={require('../../../../assets/images/NBAService/logo/jump.jpg').default}
          icon="touch_app"
          title={<>Jump Connect</>}
        ...
        <RotatingCardBack
          image={require('../../../../assets/images/NBAService/logo/jump.jpg').default}
          title="Jump Connect"
          description="โปรแกรม Jump Connect."
          action={{
            type: 'internal',
            route:
              'https://www.jumpconnect.net/member/member_regis_info.php?sp_code=27982&qr_code=1',
            label: 'เว็บไซต์'
          }}
        />
      </RotatingCard>
