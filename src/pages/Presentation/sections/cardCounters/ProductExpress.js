        ...
        {action && (
          <MKBox width="50%" mt={2} mb={2} mx="auto">
            {action.type === 'external' ? (
              <MKButton
                onClick={() =>
                  window.open('https://product-express.nbadigitalservice.com/', '_blank')
                }
                component={MuiLink}
                href={action.route}
                target="_blank"
  ...
  return (
    <MKBox sx={{ pr: 1, pl: 1 }}>
      <RotatingCard>
        <RotatingCardFront
          image={
            require('../../../../assets/images/NBAService/logo/logoWeb/ProductExpress.png').default
          }
          icon="touch_app"
        ...
        <RotatingCardBack
          ...
          title="Product Express"
          description="ซื้อขายสินค้าต่างประเทศ."
          action={{
            type: 'internal',
