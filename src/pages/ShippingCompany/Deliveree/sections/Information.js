      ...
      <Container>
        <Grid container spacing={3}>
          <Grid item xs={12} lg={3}>
            <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.8 }}>
              <Grid container justifyContent="flex-start">
                <Image src={Deliveree} rounded={false} raised={false} alt="Image" />
              </Grid>
            </motion.button>
          </Grid>
                ...
                <CardActionArea>
                  <CardContent>
                    <Typography gutterBottom variant="h5" component="div">
                      <H6 color="black">
                        บริษัท เดลิเวอรี (ไทยแลนด์) จำกัด ให้บริการส่งของ 2 รูปแบบ
                        คือแบบเหมาคันและแบบรายชิ้น
                        โดยคุณสามารถเลือกบริการที่ต้องการใช้ในขั้นตอนที่หนึ่งของการจอง.
                      </H6>
                    </Typography>
          ...
          <Grid item xs={12} lg={2} sx={{ ml: 'auto', mt: { xs: 3, lg: 0 }, alignItems: 'center' }}>
            <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.8 }}>
              <Button
                onClick={() => window.open('https://www.deliveree.com/th/', '_blank')}
                color="purple"
                buttonType="outline"
                size="regular"
                rounded={false}
